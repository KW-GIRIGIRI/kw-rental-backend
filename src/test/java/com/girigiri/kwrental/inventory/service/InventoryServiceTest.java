...
class InventoryServiceTest {
	...
	void saveInventory() {
		...
		given(equipmentValidator.validateRentalDays(any(), any())).willReturn(equipment);
	...
	void saveInventory_update() {
		...
		doNothing().when(remainQuantityValidator).validateAmount(1L, updateAmount, inventory.getRentalPeriod());
