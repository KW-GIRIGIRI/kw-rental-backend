...
public class EquipmentReservationWithRentalSpecsResponse {
    ...
    public static EquipmentReservationWithRentalSpecsResponse of(final EquipmentReservationWithMemberNumber equipmentReservationWithMemberNumber, final List<EquipmentRentalSpec> rentalSpecs) {
    ...
    private static List<ReservationSpecWithRentalSpecsResponse> mapToReservationSpecWithRentalSpecResponse(final List<EquipmentRentalSpec> rentalSpecs, final EquipmentReservationWithMemberNumber equipmentReservationWithMemberNumber) {
