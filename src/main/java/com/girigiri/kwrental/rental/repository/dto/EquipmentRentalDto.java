...
public class EquipmentRentalDto {
    ...
    public EquipmentRentalDto(final LocalDate startDate, final LocalDate endDate, final Collection<RentalSpecDto> rentalSpecs) {
    ...
    public boolean equals(final Object o) {
        ...
        final EquipmentRentalDto rentalDto = (EquipmentRentalDto) o;
