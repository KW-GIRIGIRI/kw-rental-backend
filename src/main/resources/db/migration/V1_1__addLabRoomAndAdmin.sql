insert into asset (max_rental_days, name, total_quantity, is_available, dtype, reservation_count_per_day)
values (1, 'hanul', 16, true, 'lab_room', 16);
insert into asset (max_rental_days, name, total_quantity, is_available, dtype, reservation_count_per_day)
values (1, 'hwado', 10, true, 'lab_room', 3);
